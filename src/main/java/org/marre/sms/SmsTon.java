...
public final class SmsTon {
	/**
	 * "Unknown" is used when the user or network has no priori information about the numbering plan. In this case, the Address-Value field is organized according to the network
	...
	/**
	 * "Subscriber number" is used when a specific short number representation is stored in one or more SCs as part of a higher layer application. (Note that "Subscriber number"
	...
	/**
	 * Type-Of-Number - Alphanumeric. Number must be coded according to 3GPP TS 23.038 GSM 7-bit default alphabet.
	 * <p>
	...
	public static SmsTon valueOf(int value) {
		switch (value) {
			...
			case 0x06 :
				return ABBREVIATED;
			default :
				return new SmsTon(value, String.valueOf(value));
		}
	}
