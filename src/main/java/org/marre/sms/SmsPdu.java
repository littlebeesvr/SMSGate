...
public class SmsPdu {
	 ...
	 *            The content
	 * @param udLength
	 *            The length of the content. Can be in octets or septets depending on the DCS
	 */
	 ...
	 * 
	 * @return A byte array representing the UDH fields or null if there aren't any UDH
	 */
