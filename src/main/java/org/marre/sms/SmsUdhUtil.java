...
public final class SmsUdhUtil {
	 ...
	 *
	 * @param refNr
	 *            The reference number of this SMS, must be the same in all SMS. Max 255.
	 ...
	 * <i> "In the case where this IEI is to be used in a concatenated SM then the IEI, its associated IEI length and IEI data shall be contained in the first segment of the
	 * concatenated SM. The IEI, its associated IEI length and IEI data should also be contained in every subsequent segment of the concatenated SM although this is not mandatory.
	 * However, in the case where these elements are not contained in every subsequent segment of the concatenated SM and where an out of sequence segment delivery occurs or where
	 * the first segment is not delivered then processing difficulties may arise at the receiving entity which may result in the concatenated SM being totally or partially
	 * discarded." </i>
	 *
	 * @param storeMsg
	 *            Set to true if the message should be stored
	 * @param msgType
	 *            Message type, may be one of MESSAGE_WAITING_VOICE, MESSAGE_WAITING_FAX, MESSAGE_WAITING_EMAIL or MESSAGE_WAITING_OTHER.
	 * @param msgCount
	 *            Number of messages waiting for retrieval. Max 255 messages. The value 255 shall be taken to mean 255 or greater.
	 * @return A SmsUdhElement
	 */
	 ...
	 * <p>
	 * <b>Special handling in concatenated messages:</b><br>
	 * <i> In the case where this IE is to be used in a concatenated SM then the IEI, its associated IEI length and IEI data shall be contained in the first segment of the
	 * concatenated SM. The IEI, its associated IEI length and IEI data shall also be contained in every subsequent segment of the concatenated SM. </i>
	 * 
	 * @param destPort
	 *            Destination port
	 * @param origPort
	 ...
	 *
	 * @param refNr
	 *            The reference number of this SMS, must be the same in all SMS. Max 65536
	 * @param totalNumberOfSms
	 *            Total number of SMS. Max 255
	 * @param seqNr
	 *            Sequence number. Max 255
