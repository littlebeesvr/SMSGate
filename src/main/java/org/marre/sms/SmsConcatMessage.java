 ...
 * <p>
 * - Only usable for messages that uses the same UDH fields for all message parts. <br>
 * - This class could be better written. There are several parts that are copy- pasted. <br>
