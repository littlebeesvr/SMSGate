...
public final class SmsUdhIei {
	 ...
	 * 
	 * @param value
	 *            The UDH IEI value as specified in the GSM spec.
	...
	/**
	 * 参考： <a href="https://en.wikipedia.org/wiki/User_Data_Header">协议</a>
	 */
	final static String[] InfoEleNameList = new String[]{"0	Concatenated short messages, 8-bit reference number", "1	Special SMS Message Indication", "2	Reserved",
			"3	Not used to avoid misinterpretation as <LF> character", "4	Application port addressing scheme, 8 bit address",
			"5	Application port addressing scheme, 16 bit address", "6	SMSC Control Parameters", "7	UDH Source Indicator",
			"8	Concatenated short message, 16-bit reference number", "9	Wireless Control Message Protocol", "0A	Text Formatting", "0B	Predefined Sound",
			"0C	User Defined Sound (iMelody max 128 bytes)", "0D	Predefined Animation", "0E	Large Animation (16*16 times 4 = 32*4 =128 bytes)",
			"0F	Small Animation (8*8 times 4 = 8*4 =32 bytes)", "10	Large Picture (32*32 = 128 bytes)", "11	Small Picture (16*16 = 32 bytes)", "12	Variable Picture",
			"13	User prompt indicator", "14	Extended Object", "15	Reused Extended Object", "16	Compression Control", "17	Object Distribution Indicator",
			"18	Standard WVG object", "19	Character Size WVG object", "1A	Extended Object Data Request Command", "1B	Reserved for future EMS features",
			"1C	Reserved for future EMS features", "1D	Reserved for future EMS features", "1E	Reserved for future EMS features", "1F	Reserved for future EMS features",
			"20	RFC 822 E-Mail Header", "21	Hyperlink format element", "22	Reply Address Element", "23	Enhanced Voice Mail Information", "24	National Language Single Shift",
