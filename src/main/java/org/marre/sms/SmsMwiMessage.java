 ...
 * 
 * On a Sony-Ericsson T610 these messages can be used to display different types of icons in the notification bar.
 * 
...
public class SmsMwiMessage extends SmsTextMessage {
	 ...
	 *            Description of this message
	 * @param alphabet
	 *            Alphabet to use. Valid values are SmsDcs.ALPHABET_*.
	 */
	 ...
	 * 
	 * @param type
	 *            Type of message that is waiting. Can be any of TYPE_*.
	 * @param count
	 *            Number of messages waiting for retrieval.
	 */
