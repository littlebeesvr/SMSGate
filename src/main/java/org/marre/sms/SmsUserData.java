...
public class SmsUserData {
	 ...
	 * 
	 * This can be in characters or byte depending on the message (DCS). If message is 7 bit coded the length is given in septets. If 8bit or UCS2 the length is in octets.
	 * 
	 * @return The length
	 */
