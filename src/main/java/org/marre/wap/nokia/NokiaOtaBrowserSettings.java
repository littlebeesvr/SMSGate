...
public class NokiaOtaBrowserSettings implements WbxmlDocument, Serializable {
	...
	public static final String[] OTA_TAG_TOKENS = {"CHARACTERISTIC-LIST", // 05
			"CHARACTERISTIC", // 06
			"PARM", // 07
	};

	public static final String[] OTA_ATTR_START_TOKENS = {"", // 05
			"TYPE=ADDRESS", // 06
			"TYPE=URL", // 07
			"TYPE=NAME", // 08
			"", // 09
	...
	public static final String[] OTA_ATTR_VALUE_TOKENS = {"", // 85
			"", // 86
			"", // 87
	};
	...
	/*
	 * ADDRESS: BEARER PPP_AUTHTYPE PPP_AUTHSECRET PPP_LOGINTYPE PROXY PROXY_TYPE PROXY_AUTHNAME PROXY_AUTHSECRET PROXY_LOGINTYPE PORT CSD_DIALSTRING CSD_CALLTYPE CSD_CALLSPEED
	 * ISP_NAME SMS_SMSC_ADDRESS USSD_SERVICE_CODE GPRS_ACCESSPOINTNAME
	 */
