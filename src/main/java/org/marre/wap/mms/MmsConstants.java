...
public final class MmsConstants {
	...
	public static final String[] HEADER_NAMES = {null, "bcc", "cc", "x-mms-content-location", "content-type", "date", "x-mms-delivery-report", "x-mms-delivery-time",
			"x-mms-expiry", "from", "x-mms-message-class", "message-id", "x-mms-message-type", "x-mms-mms-version", "x-mms-message-size", "x-mms-priority", "x-mms-read-reply",
			"x-mms-report-allowed", "x-mms-response-status", "x-mms-response-text", "x-mms-sender-visibility", "x-mms-status", "subject", "to", "x-mms-transaction-id"};
	...
	public static final String[] X_MMS_MESSAGE_TYPE_NAMES = {"m-send-req", "m-send-conf", "m-notification-ind", "m-notifyresp-ind", "m-retrieve-conf", "m-acknowledge-ind",
			"m-delivery-ind"};
