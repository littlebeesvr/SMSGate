...
/**
 * <p>
 * Implementation of the Attribute event in the wbxml-stream library.
 * </p>
 * 
 * @author ricky
 */
class WbXmlAttributeEvent extends WbXmlEvent implements Attribute {
	 ...
	 * 
	 * @param attr
	 *            The attribute of the StartElement.
	 * @param stream
	 *            The stream for the location.
	 */
	...
	/**
	 * Gets the type of this attribute, default is the String "CDATA". This implementation always return CDATA.
	 * 
	...
	/**
	 * A flag indicating whether this attribute was actually specified in the start-tag of its element, or was defaulted from the schema. It always return true;
	 * 
	 * @return
	 */
	@Override
