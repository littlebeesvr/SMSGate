...
/**
 * <p>
 * Implementation of the EndElement event in the wbxml-stream library.
 * </p>
 * 
 * @author ricky
 */
public class WbXmlEndElementEvent extends WbXmlEvent implements EndElement {
	 ...
	 * 
	 * @param stream
	 *            The stream being read and positioned at EndElement
	 */
	...
	/**
	 * Returns an Iterator of namespaces that have gone out of scope. Returns an empty iterator if no namespaces have gone out of scope. It always return the empty list.
	 * 
	...
	public String toString() {
		return new StringBuilder("EndElement: ").append(this.element).toString();
	}
}
