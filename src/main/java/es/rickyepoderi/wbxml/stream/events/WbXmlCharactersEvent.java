...
/**
 * <p>
 * Implementation of the Characters event in the wbxml-stream library.
 * </p>
 * 
 * @author ricky
 */
public class WbXmlCharactersEvent extends WbXmlEvent implements Characters {
	 ...
	 * 
	 * @param stream
	 *            The stream in the CHARACTERS event.
	...
	/**
	 * Returns true if this set of Characters is all whitespace. Whitespace inside a document is reported as CHARACTERS. This method allows checking of CHARACTERS events to see if
	 * they are composed of only whitespace characters
	 * 
	...
	/**
	 * Returns true if this is a CData section. If this event is CData its event type will be CDATA If javax.xml.stream.isCoalescing is set to true CDATA Sections that are
	 * surrounded by non CDATA characters will be reported as a single Characters event. This method will return false in this case.
	 * 
	...
	public String toString() {
		return new StringBuilder("Characters: ").append(this.text).toString();
	}
}
