...
/**
 * <p>
 * Implementation of the StartDocument event in the wbxml-stream library.
 * </p>
 * 
 * @author ricky
 */
public class WbXmlStartDocumentEvent extends WbXmlEvent implements StartDocument {
	...
	/**
	 * Constructor that creates the event from a stream positioned in the START_DOCUMENT.
	 * 
	 * @param stream
	 *            The stream positioned at START_DOCUMENT.
	 */
	...
	/**
	 * Returns the encoding style of the XML data. It returns the charset defined in the WBXML document.
	 * 
	...
	/**
	 * Returns the version of XML of this XML stream. It always return "1.0" no matter the version of the wbxml document.
	 * 
	...
	public String toString() {
		return new StringBuilder("StartDocument: ").append(this.encoding).toString();
	}
}
