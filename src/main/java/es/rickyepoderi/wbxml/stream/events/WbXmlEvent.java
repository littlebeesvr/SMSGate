...
/**
 * <p>
 * WbXml-Stream implementation for the XMLEvent interface. This class is a simple representation of the XMLEvent. It uses the WbXmlStreamReader in order to create the event.
 * </p>
 * 
 * @author ricky
 */
public class WbXmlEvent implements XMLEvent {
	...
	/**
	 * Constructor based on the stream. It creates all the properties based on the current state of the stream reader.
	 * 
	 * @param stream
	 *            The stream reader
	 */
	...
	/**
	 * Constructor that based on stream but fixes the type. It is used from StartElement to create the attributes.
	 * 
	 * @param stream
	 */
	...
	/**
	 * Cast the event into a StartElement. It throws a ClassCastException if it is not.
	 * 
	...
	/**
	 * Cast the event into a EndElement. It throws a ClassCastException if it is not.
	 * 
	...
	/**
	 * Cast the event into a Characters. It throws a ClassCastException if it is not.
	 * 
	...
	/**
	 * This method is provided for implementations to provide optional type information about the associated event. It is optional and will return null if no information is
	 * available. It always return null.
	 * 
	 * @return null
	 */
	@Override
	...
	/**
	 * This method will write the XMLEvent as per the XML 1.0 specification as Unicode characters. No indentation or whitespace should be outputted. Any user defined event type
	 * SHALL have this method called when being written to on an output stream. Built in Event types MUST implement this method, but implementations MAY choose not call these
	 * methods for optimizations reasons when writing out built in Events to an output stream. The output generated MUST be equivalent in terms of the infoset expressed. It does
	 * nothing for all the wbxml-stream implementation.
	 * 
	 * @param writer
