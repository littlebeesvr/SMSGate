 ...
 * </p>
 * 
 * Namespace URI: Namespace name expressed as a URI to which the prefix is bound prefix: syntactically, this is the part of the attribute name following the
 * XMLConstants.XMLNS_ATTRIBUTE ("xmlns") in the Namespace declaration example: &lt;element xmlns:prefix="http://Namespace-name-URI"&gt;
 * 
 * <p>
 ...
 * 
 * <p>
 * Note that a Namespace URI can be bound to multiple prefixes in the current scope. This can occur when multiple XMLConstants.XMLNS_ATTRIBUTE ("xmlns") Namespace declarations
 * occur in the same Start-Tag and refer to the same Namespace URI. e.g.
 * </p>
 * 
 * <pre>
...
public class WbXmlNamespaceContext implements NamespaceContext {
	 ...
	 * 
	 * @param prefix
	 *            The prefix to get the URI from
	...
	/**
	 * Get prefix bound to Namespace URI in the current scope. To get all prefixes bound to a Namespace URI in the current scope, use getPrefixes(String namespaceURI).
	 * 
	 * @param namespaceURI
