...
/**
 * <p>
 * The output factory to create stream and event writer for the WBXML format. They supports three properties:
 * </p>
 * 
 * <ul>
 * <li>es.rickyepoderi.wbxml.stream.encodingType: The encoding type. The value should be a WbXmlEncoder.StrblType (default IF_NEEDED).</li>
 * <li>es.rickyepoderi.wbxml.stream.skipSpaces: The encoder will trim spaces. Boolean value (true by default).</li>
...
public class WbXmlOutputFactory extends XMLOutputFactory {
	...
	/**
	 * The property for defining the encoding type. The value should be a WbXmlEncoder.StrtblType (default to IF_NEEDED).
	 */
	...
	/**
	 * Create a new XMLEventWriter that writes to a stream. Throws a XMLStreamExcption cos WBXML is binary, use the other methods.
	 * 
	 * @param writer
	...
	public XMLStreamWriter createXMLStreamWriter(OutputStream out) throws XMLStreamException {
		return new WbXmlStreamWriter(out, (WbXmlDefinition) props.get(DEFINITION_PROPERTY), (WbXmlEncoder.StrtblType) props.get(ENCODING_TYPE_PROPERTY),
	...
	public XMLStreamWriter createXMLStreamWriter(OutputStream out, String encoding) throws XMLStreamException {
		return new WbXmlStreamWriter(out, (WbXmlDefinition) props.get(DEFINITION_PROPERTY), (WbXmlEncoder.StrtblType) props.get(ENCODING_TYPE_PROPERTY),
				(Boolean) props.get(SKIP_SPACES_PROPERTY), encoding);
	}

	/**
	 * Create a new XMLStreamWriter that writes to a JAXP result. It only works with a StreamResult.
	 * 
	 * @param result
	...
	public XMLStreamWriter createXMLStreamWriter(Result result) throws XMLStreamException {
		try {
			if (result instanceof StreamResult) {
				return new WbXmlStreamWriter(new FileOutputStream(result.getSystemId()), (WbXmlDefinition) props.get(DEFINITION_PROPERTY),
						(WbXmlEncoder.StrtblType) props.get(ENCODING_TYPE_PROPERTY), (Boolean) props.get(SKIP_SPACES_PROPERTY));
			} else {
	...
	/**
	 * Create a new XMLEventWriter that writes to a JAXP result. This method is optional. It is only valid for a a StreamResult.
	 * 
	 * @param result
	 *            the result to write to
	...
	public XMLEventWriter createXMLEventWriter(Result result) throws XMLStreamException {
		try {
			if (result instanceof StreamResult) {
				return new WbXmlEventWriter(new FileOutputStream(result.getSystemId()), (WbXmlDefinition) props.get(DEFINITION_PROPERTY),
						(WbXmlEncoder.StrtblType) props.get(ENCODING_TYPE_PROPERTY), (Boolean) props.get(SKIP_SPACES_PROPERTY));
			} else {
				throw new XMLStreamException("WBXML only support StreamResult!");
			}
	...
	public XMLEventWriter createXMLEventWriter(OutputStream out) throws XMLStreamException {
		return new WbXmlEventWriter(out, (WbXmlDefinition) props.get(DEFINITION_PROPERTY), (WbXmlEncoder.StrtblType) props.get(ENCODING_TYPE_PROPERTY),
				(Boolean) props.get(SKIP_SPACES_PROPERTY));
	}
	...
	/**
	 * Create a new XMLEventWriter that writes to a writer. It is not supported cos WBXML is a binary stream. Use the rest of methods.
	 * 
	 * @param writer
	 *            the stream to write to
	 * @return The event writer implementation for WBXML
