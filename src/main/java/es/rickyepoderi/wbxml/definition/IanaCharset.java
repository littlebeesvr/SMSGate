 ...
 * 
 * <p>
 * The IANA charset as defined in the following <a href="http://www.iana.org/assignments/character-sets">link</a>. Not all the charsets in IANA are defined in Java, the following
 * link lists all <a href="http://docs.oracle.com/javase/1.5.0/docs/guide/intl/encoding.doc.html">the charsets defined in JavaSe (version 5)</a>
 * </p>
 * 
 * <p>
...
public enum IanaCharset {
	 ...
	 * 
	 * @param alias
	 *            The name or the alias of the charset to retrieve.
	 ...
	 * 
	 * @param mib
	 *            The MIB identifier of teh charset
	...
	/**
	 * Method to return a Java charset using the name. It is used to catch the associated exception if the charset is not defined in Java.
	 * 
	 * @param name
	 *            The name of the charset
	...
	/**
	 * Method that search the Java associated Charset to the IANA one. This method tries to locate the Java charset using the name and all the alias of the charset, if found that
	 * Java Charset is returned, if not, it defaults to ASCII.
	 * 
