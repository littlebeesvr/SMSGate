...
/**
 * <p>
 * This class represents the part of the specification for a WBXML language that list the attributes in that language. This part is defined in the chapter <em>5.8.3. Attribute Code
 * Space (ATTRSTART and ATTRVALUE)</em> of the specification.
 * </p>
 * 
 * <p>
 * An attribute is a token represented in a byte (7 bits specifically cos it should be less than 128) and it can represents the name of the attribute and part (of all) of its
 * value.
 * </p>
 * 
 * <p>
 * the commented chapter says the following: tokens with a value less than indicate the start of an attribute. The attribute start token fully identifies the attribute name, e.g.,
 * <em>URL=</em>, and may optionally specify the beginning of the attribute value, e.g.,<em>PUBLIC="TRUE"</em>. Unknown attribute names are encoded with the globally unique code
 * LITERAL. LITERAL must not be used to encode any portion of an attribute value.
 * </p>
 * 
 * <p>
 * In the properties file the attributes are specified with the following key format:
 * </p>
 * 
 * <ul>
 ...
 * 
 * <p>
 * The definition of the two attributes commented in the specification would be the followint:
 * </p>
 * 
 * <ul>
 * <li>
 * <p>
 * <em>URL=</em> in the page 0 with token 0x05:
 * </p>
 * <p>
 ...
 * <li>
 * <p>
 * <em>PUBLIC="TRUE"</em> in page 0, tag 0x06:
 * </p>
 * <p>
 ...
 * 
 * <p>
 * As you see the idea is simple each attribute is defined in a page with a numeric token less than 128, the optional value is represented using a second key terminates with
 * ".value". If the attribute is associated with a namespace the attribute name is prefix:attribute-name.
 * </p>
 * 
 * <p>
 * The definition loads the attributes in such order that always the more suited attributes is checked first (obviously if there are some keys defined for the same attribute the
 * more lengthed value the better.
 * </p>
 * 
 * @author ricky
 */
public class WbXmlAttributeDef implements Comparable<WbXmlAttributeDef> {
	 ...
	 * 
	 * @param prefix
	 *            The prefix (namespace) of the attribute
	 * @param name
	 *            The name of the attribute
	 * @param token
	 *            The token byte
	 ...
	 * 
	 * @param prefix
	 *            The attribute prefix (namespace)
	 * @param name
	 *            The attribute name
	 * @param token
	...
	/**
	 * return the name prefixed "prefix:name" of the attribute, if there is no namespace defined normal name is returned.
	 * 
	 ...
	 * 
	 * @param token
	 *            The new token associated to this attribute
	 */
	 ...
	 * 
	 * @param prefix
	 *            Thew new prefix (should be one defined in the namespaces)
	 */
	...
	public String toString() {
		...
		sb = sb.append(name);
		sb.append("=").append(value).append("->").append(token).append(System.getProperty("line.separator"));
		return sb.toString();
	}
}
