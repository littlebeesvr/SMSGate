 ...
 * 
 * <p>
 * Java representation of an WBXML element. The element in the specification is defined like this:
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * So it is a tag with attributes and contents.
 * </p>
 * 
 * @author ricky
 */
public class WbXmlElement {
	...
	/**
	 * Constructor via the tag name. The tag should be prefixed if the definition uses namespaces.
	 * 
	 * @param tag
	 ...
	 *            The attribute
	 * @param elements
	 *            Several elements to be used as contents
	 */
	 ...
	 * 
	 * @param idx
	 *            The position to get the content from
	...
	/**
	 * Method that compacts the contents of the element. As you know WBXML has extensions to reduce the length of string contents. This way this method searches for possible
	 * extensions. The definition methods for compacting are used. After this method the element is compacted.
	 * 
	 * @param encoder
	 *            The encoder object used in the encoding process
	 */
	...
	/**
	 * Method that joins all consecutive string contents into one. After that the element is nor compacted.
	 */
