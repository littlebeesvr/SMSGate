...
/**
 * <p>
 * OTA definition has a property which is an icon (binary image). In XML the Base64 representation of the binary is used.
 * </p>
 * 
 * @author ricky
 */
public class OtaBase64Opaque implements OpaqueAttributePlugin {
	...
	/**
	 * Encode method that encodes a opaque data. The Base64 is decoded in case of ICON in order to save into the WBXML the binary image.
	 * 
	 * @param encoder
	...
	/**
	 * Parse method that parses an opaque data. The binary is encoded into Base64 (the new lines are removed).
	 * 
	 * @param parser
