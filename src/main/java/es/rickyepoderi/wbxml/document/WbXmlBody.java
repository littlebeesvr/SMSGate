 ...
 * 
 * <p>
 * Java representation of the body of the WBXML format. Body is the main part of the WBXML document (all WBXML documents have a unique body). based on the format specification the
 ...
 * 
 * <p>
 * The class is just a pre list of attributes (PI is just an attribute with PI and END token), and element and a list of post pis attributes.
 * </p>
 * 
 * @author ricky
 */
public class WbXmlBody {
	 ...
	 * 
	 * @param prePi
	 *            The pre PIs attributes
	 * @param element
	 *            The main element of the document
	 * @param postPi
	 *            The post PIs attributes
	 */
	 ...
	 * 
	 * @param i
	 *            The position of the PI to return
	 ...
	 * 
	 * @param pi
	 *            The PI attribute to add at the end of the post PI list
	 * @return The same body to chain calls
	 */
	...
	/**
	 * Getter for the post PI attributes. It returns the PI attribute in the i position of the post PI list.
	 * 
	 * @param i
	 *            The position to get the attribute from
