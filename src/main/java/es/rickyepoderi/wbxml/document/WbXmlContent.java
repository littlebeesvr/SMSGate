 ...
 * 
 * <p>
 * Java representation of the content of an element in the WBXML format. Following the specification the content is the following:
 * </p>
 * 
 * <pre>
 *  
 ...
 * 
 * <p>
 * So this class is just a typical C union, in which the value of the content can be a String (it represents the STR_I, STR_T, extension and entity), another element (element) or
 * PI attribute (remember PI is just like an attribute). Opaque data is managed using the plugins. Obviously only one can be not null.
 * </p>
 * 
 * @author ricky
 */
public class WbXmlContent {
	...
	/**
	 * Setter for the element. Sets the element and set two null or the other possibilities.
	 * 
	 * @param element
	 *            The element to set
	 ...
	 * 
	 * @param string
	 *            The string that compounds the content
	...
	/**
	 * Checks if the content is a PI content. it returns true if the pi property is not null.
	 * 
