...
public class ByteArrayUtil {
	...
	/**
	 * Helper method for validating if an offset and length are valid for a given byte array. Checks if the offset or length is negative or if the offset+length would cause a read
	 * past the end of the byte array.
	 * 
	 * @param bytesLength
	 *            The length of the byte array to validate against
	 * @param offset
	 *            The offset within the byte array
	 * @param length
	 *            The length to read starting from the offset
	 * @throws java.lang.IllegalArgumentException
	 *             If any of the above conditions are violated.
	 */
	static protected void checkOffsetLength(int bytesLength, int offset, int length) throws IllegalArgumentException {
