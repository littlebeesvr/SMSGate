...
public final class CMPPCommonUtil {
	 ...
	 * 
	 * Bit No.7 与Bit No.6 :一般设置为00； Bit No.5： 0—文本未压缩， 1—文本用GSM 标准压缩算法压缩 Bit No.4： 0—表示Bit No.1、Bit No.0 为保留位，不含信息类型信息， 1—表示Bit No.1、Bit No.0 含有信息类型信息 Bit No.3 与Bit No.2：
	 * 00—默认的字母表(7bit 编码) 01—8bit， 10—USC2（16bit）编码 11—预留 Bit No.1 与Bit No.0： 00—Class 0， 01—Class 1， 10—Class 2（SIM 卡特定信息）， 11—Class 3//写卡
	 */
