...
public class DeliverSmReceiptCodec extends MessageToMessageCodec<DeliverSm, DeliverSmReceipt> {
	...
	protected void decode(ChannelHandlerContext ctx, DeliverSm msg, List<Object> out) throws Exception {
		/*
		 * 
		 * x x 0 0 0 0 x x Default message Type (i.e. normal message) x x 0 0 0 1 x x Short Message contains SMSC Delivery Receipt x x 0 0 1 0 x x Short Message contains SME
		 * Delivery Acknowledgement x x 0 0 1 1 x x reserved x x 0 1 0 0 x x Short Message contains SME Manual/User Acknowledgment x x 0 1 0 1 x x reserved x x 0 1 1 0 x x Short
		 * Message contains Conversation Abort (Korean CDMA) x x 0 1 1 1 x x reserved x x 1 0 0 0 x x Short Message contains Intermediate Delivery Notification
		 */
