...
public abstract class Pdu implements BaseMessage, Cloneable {
	...
	/**
	 * Gets the current list of optional parameters. If no parameters have been added, this will return null.
	 * 
	...
	/**
	 * Adds an optional parameter to this PDU. Does not check if the TLV has already been added (allows duplicates).
	 * 
	 * @param tlv
	 *            The TLV to add
	...
	/**
	 * Sets an optional parameter by checking if the tag already exists in our list of optional parameters. If it already exists, will replace the old value with the new value.
	 * 
	 * @param tlv
	 *            The TLV to add/set
