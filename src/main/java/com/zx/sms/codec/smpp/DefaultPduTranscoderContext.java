...
/**
 * Provides a default context for a PduTranscoder by looking everything up using SMPP constants or default settings. An "override" context can be supplied in the constructor. By
 * default, this context will then attempt to call the overridden context and any null value returned will then be looked up using standard rules.
 * 
