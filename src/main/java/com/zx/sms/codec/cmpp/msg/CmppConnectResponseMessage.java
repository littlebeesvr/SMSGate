...
public class CmppConnectResponseMessage extends DefaultMessage {
	...
	public String toString() {
		return String.format("CmppConnectResponseMessage [version=%s, status=%s,authenticatorISMG = %s, sequenceId=%s]", version, status, Hex.encodeHexString(authenticatorISMG),
