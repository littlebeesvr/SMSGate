 ...
 *
 */
public class SgipReportResponseMessage extends DefaultMessage {
	...
	public String toString() {
		return String.format("ReportResponseMessage [result=%s, reserve=%s,  header=%s]", result, reserve, getHeader());
	}
